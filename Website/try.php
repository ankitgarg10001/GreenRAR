...
$anchor=$doc->getElementsByTagName($content_tag);
echo "here";
echo "here1";
foreach($anchor as $elements)
{
    if ($elements->getAttribute('id')== $content) {
        echo "here2";
        echo "<br/>". $elements->nodeName. ": ";
...
//    echo "here";
//    if ($tag->getAttribute('id')== $content) {
//       // print_t($tag->nodevalue);
//        echo "<br>here".$tag->nodeValue."<br>";
//        foreach($doc->getElementsByTagName($content_tag) as $tag) {
//    echo "here";
//    if ($tag->getAttribute('id')== $content) {
//       // print_t($tag->nodevalue);
