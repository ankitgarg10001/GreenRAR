...
{var stre=  document.POSTElementById("string1").value;
	if(st=='raj')
{
var ret= stre+'<img src="smile/icon_biggrin.gif" alt="Very Happy" title="Very Happy" border="0">';
	...
	document.POSTElementById("string1").value=ret;
	}

function showResult(str1)
{

var str=  document.POSTElementById("string1").value;
...
xmlhttp1.open("POST","server.php?string="+str+"&sort="+str1,true);
xmlhttp1.send();
}
</script>
...
<br>
 ...
 <a href="http://www.postimage.org/" tarPOST="_blank">UPLOAD HERE</a>
 </div>
