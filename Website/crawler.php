    ...
    <div id="wrapper" class="hfeed">
        ...
        <div id="main">
           <div style="margin-top:20px;padding:20px;">
            <h1 class="head">Search Results for "<?php echo $_GET['q'] ?>"</h1>
           </div>
        <?php
        include 'simple_html_dom.php';
        set_time_limit(300);
        $ans=array();
        $str1="http://www.enn.com";
        $str2="http://www.ens-newswire.com/";
        ...
        mysql_query("DELETE FROM crawler");
        func($str1);
        func($str2);
        class Crawler
        {
            ...
            if(isset($str) && $str != '')
            {
                ...
                if(!empty($links))
                {
                    ...
                    foreach($links as $link)
                    {
                        ...
                        if($link[0]=='h' && $link[4]!='s' && (strpos($link,"enn") !== false||strpos($link,"ens-newswire") !== false ||strpos($link,"topics") !== false||strpos($link,"article") !== false||strpos($link,"spotlight") !== false||strpos($link,"blog") !== false))
                        {
                            //echo $link."<br>";
                            ...
                            //if($link[0] == "/")
                            //    $link = $str.$link;
                            //$s1= "<a href='http://".$link."'>".$link."</a><br>";
                            //echo "<tr><td ".$style.">".$s1."</td></tr>";
                            //$j++;
                            
                            $link=mysql_real_escape_string($link);
                            mysql_query("INSERT INTO crawler (link) VALUES ('".$link."')");
                        }
                    }
                    $result=mysql_query("select distinct link from crawler");
