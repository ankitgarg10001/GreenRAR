...
<body class="home" style="background-color: aqua;">
    ...
    <div id="wrapper" class="hfeed">
        ...
        <div id="main">
            ...
            $sql = "SELECT * FROM blog where `email` LIKE '%$a%'";
            $res=mysql_query($sql,$con);
            $arr=array();
            echo "<div id='main_post'>";
            echo "<span style='font-size:14px;font-weight:bold;float: left;text-transform: uppercase;'>All Posts By $a</span><br/><br/>";
